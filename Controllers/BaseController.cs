...
public abstract class BaseController : Controller
{
	...
	public BaseController(TransportationContext context, IHttpContextAccessor accessor)
	{
		_context = context;
		try
		{
			...
			{
				LoggedUser = System.Text.Json.JsonSerializer.Deserialize<Uzivatel>(serializedUser);
	...
	protected bool LoginInternal(string username, string password)
	{
		...
		password = OurCryptography.Encrypt(password);
